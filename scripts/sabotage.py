...
SABOTAGES = [
    ...
    {
        "name": 'the_campaign_run_passes_the_look',
        "file": 'app/skill_pack.py',
        "find": '                                   webview=webview, look=_look)\n',
        "replace": '                                   webview=webview, look=None)\n',
        "suites": ['test_a_structure_is_how_not_what.py'],
    ...
    },
    {
        ...
        "file": 'app/email_render.py',
        "find": "NOT_DRAWN_YET = {\"imagery.hero\": \"Phase 5\", \"imagery.product\": \"Phase 5\",\n",
        "replace": "NOT_DRAWN_YET = {\"cta.style\": \"Phase 9\", \"imagery.hero\": \"Phase 5\", \"imagery.product\": \"Phase 5\",  # SABOTAGE\n",
        "suites": ['test_a_design_is_executed.py'],
