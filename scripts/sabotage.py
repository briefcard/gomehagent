...
SABOTAGES = [
    ...
    },
    {
        ...
        'file': 'app/layers.py',
        'find': '        shapes.append(_pill(sid, "CTA", cb, ask, font_px=cb["font_px"], fill=accent,\n                            colour=accent_text, face=body_face))',
        'replace': '        shapes.append(_pill(sid, "CTA", cb, ask, font_px=cb["font_px"], fill="000000",  # SABOTAGE\n                            colour=accent_text, face=body_face))',
