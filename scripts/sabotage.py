...
SABOTAGES = [
    ...
    },
    {
        ...
        "file": 'app/email_design.py',
        "find": "    rows = [a for a in kb.assets(tenant) if (a.kind or \"image\") == \"image\"]\n",
    ...
    },
    {
        ...
        "file": 'app/email_design.py',
        "find": "            ikind = (design.get(\"imagery\") or {}).get(_IMAGERY_OF.get(kind, \"feature\"), \"lifestyle\")\n",
        "replace": "            ikind = \"texture\"  # SABOTAGE\n",
        "suites": ['test_content_fits_the_design.py'],
