...
SABOTAGES = [
    ...
    },
    {
        ...
        "file": 'app/media.py',
        "find": '            if url_for(row.id, row.mime or "image/png") in referenced:\n                continue',
        "replace": '            pass  # SABOTAGE',
        "suites": ['test_creative_seam.py'],
        "why": 'the cleanup deletes the bytes behind assets nobody has published yet, so an approved image becomes a broken link the first time somebody tries to use it',
    },
    {
