...
SABOTAGES = [
    ...
    },
    {
        ...
        'file': 'app/creative.py',
        # RE-ANCHORED 2026-09-07: the signature grew `boards`.
        # RE-ANCHORED 2026-09-07: the signature grew `image_model`.
        'find': '          situation: str = "", plates: int = 4, review: bool = True,\n          boards: tuple | list = (), image_model: str = "") -> dict:',
        'replace': '          plates: int = 4, review: bool = True,\n          boards: tuple | list = (), image_model: str = "") -> dict:  # SABOTAGE',
    ...
    },
    {
        ...
        'file': 'app/gemini_images.py',
        'find': '    for _name, blob, mime in objects + style:\n        blocks.append({"type": "image", "mime_type": mime or "image/png",',
        'replace': '    for _name, blob, mime in []:  # SABOTAGE\n        blocks.append({"type": "image", "mime_type": mime or "image/png",',
        'suites': ['test_a_second_image_provider_is_a_call_away.py'],
    ...
    },
    {
        ...
        'file': 'app/gemini_images.py',
        'find': '    objects = [i for i in images if not str(i[0]).startswith("look-")][:lim["objects"]]',
