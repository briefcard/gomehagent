...
- **`live_theme`**(tenant) → `dict`  ·  from `admin_ui.py`, `links.py`, `skill_pack.py`, `test_a_brand_fills_the_roles.py`, `test_brand_theme.py`
...
- **`fields`**() → `list[tuple[str, str, tuple, object, str]]`  ·  from `gen_email_design_doc.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_reference_is_recreated.py`
- **`house`**(look?, width?) → `dict`  ·  from `email_structures.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_structure_is_how_not_what.py`, `test_the_reader_has_eyes.py`
- **`look_of_design`**(design) → `dict`  ·  from `test_the_reader_has_eyes.py`
- **`mobile_url`**(url) → `str`  ·  from `test_the_reader_has_eyes.py`
- **`normalize`**(raw) → `tuple[dict, list[str]]`  ·  from `email_structures.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_the_reader_has_eyes.py`
...
- **`entities`**(tenant, type?, available_only?, include_proposed?) → `list[db.KbEntity]`  ·  from `admin_ui.py`, `bakeoff.py`, `brief.py`, `claim_trace.py`, `creative.py`, `dossier.py`, `email_harvest.py`, `email_structures.py`, `harvest.py`, `hosting.py`, `links.py`, `offers.py`, `planner.py`, `resolve.py`, `skill_pack.py`, `systems.py`, `tenants.py`, `test_campaign_variety.py`, `test_catalog_sync.py`, `test_entity_selectors.py`, `test_gbp_listing.py`, `test_kb.py`, `test_kb_removal.py`, `test_kb_ui.py`, `test_objection_scope.py`, `test_provenance.py`, `test_shopify_compliance.py`, `validator.py`, `web.py`
