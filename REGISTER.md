...
- **`summary`**(report) → `str`  ·  from `admin_ui.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_claim_trace.py`
...
- **`brief`**(hours_back?) → `dict`  ·  from `skill_pack.py`, `test_a_structure_is_how_not_what.py`, `test_digest.py`, `test_funnel.py`
...
- **`complete`**(design) → `bool`  ·  from `test_a_design_is_words_the_renderer_can_draw.py`
...
- **`house`**(look?, width?) → `dict`  ·  from `email_structures.py`, `test_a_design_is_executed.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_structure_is_how_not_what.py`, `test_the_reader_has_eyes.py`
- **`look_of_design`**(design) → `dict`  ·  from `test_the_reader_has_eyes.py`
- **`mobile_url`**(url) → `str`  ·  from `test_the_reader_has_eyes.py`
- **`normalize`**(raw) → `tuple[dict, list[str]]`  ·  from `email_render.py`, `email_structures.py`, `test_a_design_is_executed.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_the_reader_has_eyes.py`
...
- **`summary`**(design) → `str`  ·  from `admin_ui.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_claim_trace.py`
...
- **`group_sections`**(blocks) → `list[dict]`  ·  from `test_a_design_is_executed.py`
...
- **`render_design`**(design, theme, blocks, preheader?, webview?) → `str`  ·  from `email_design.py`, `test_a_design_is_executed.py`
...
- **`library`**(review?) → `list[dict]`  ·  from `admin_ui.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_structure_is_how_not_what.py`, `test_the_reader_has_eyes.py`
...
- **`brief`**(plan) → `str`  ·  from `skill_pack.py`, `test_a_structure_is_how_not_what.py`, `test_digest.py`, `test_funnel.py`
...
- **`fill`**(given, colors) → `tuple[dict, dict]`  ·  from `brand_theme.py`, `email_render.py`, `test_a_brand_fills_the_roles.py`, `test_sources.py`, `web.py`
...
- **`fill`**(tenant, apply?, budget?, only?) → `dict`  ·  from `brand_theme.py`, `email_render.py`, `test_a_brand_fills_the_roles.py`, `test_sources.py`, `web.py`
