...
- **`workflow`**(key) → `dict`  ·  from `admin_ui.py`, `planner.py`, `test_blog_skill.py`, `test_campaign_variety.py`, `test_entity_scope.py`, `test_plans.py`, `test_workflow_ui.py`, `web.py`, `worker.py`
