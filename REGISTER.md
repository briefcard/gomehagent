...
- **`match`**(query) → `list[dict]`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `gbp_post.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `web.py`
...
- **`match`**(tenant, limit?) → `dict`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `gbp_post.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `web.py`
