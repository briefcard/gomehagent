...
- **`run`**(key, tenant, trigger?, ref?, run_id?, **params) → `dict`  ·  from `command_agent.py`, `sabotage.py`, `seed_demo.py`, `skill_pack.py`, `test_ad_board.py`, `test_approval_gate.py`, `test_article_review.py`, `test_audience_entities.py`, `test_blog_skill.py`, `test_bundle_contract.py`, `test_campaign_email.py`, `test_campaign_measured.py`, `test_campaign_variety.py`, `test_campaign_visual.py`, `test_catalog_vocabulary.py`, `test_coherence.py`, `test_entity_scope.py`, `test_funnel.py`, `test_offers.py`, `test_plans.py`, `test_refresh_lands.py`, `test_refresh_lane.py`, `test_register.py`, `test_replies.py`, `test_skill.py`, `test_strategy_ledger.py`, `test_workroom_email.py`, `web.py`, `worker.py`
