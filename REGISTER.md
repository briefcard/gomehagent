...
- **`board`**(tenant, days?, top?) → `dict`  ·  from `admin_ui.py`, `test_article_review.py`, `test_keyword_attention.py`, `test_keywords.py`, `test_mute_replacement.py`, `test_plan_lifecycle.py`, `test_systems.py`, `web.py`
...
- **`slug`**(phrase) → `str`  ·  from `planner.py`, `skill_pack.py`, `test_plan_mix.py`
...
- **`board`**() → `list[dict]`  ·  from `admin_ui.py`, `test_article_review.py`, `test_keyword_attention.py`, `test_keywords.py`, `test_mute_replacement.py`, `test_plan_lifecycle.py`, `test_systems.py`, `web.py`
