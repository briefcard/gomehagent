...
- **`render_workroom`**(key, output_id, art, kw, ap, ok?, err?) → `str`  ·  from `test_publish_gap.py`, `test_queue_approval.py`, `test_refresh_lands.py`, `test_workroom_email.py`, `web.py`
