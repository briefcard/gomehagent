...
- HTTP routes: **220** (220 reached)
- Approval kinds: **13** (10 with an executor arm)
- Dispositions: **3**
- Autonomy rungs: **3**
...
- **`render`**(key, tenant?, msg?, err?, link?, ilink?, plink?, sub?) → `str`  ·  from `skill_pack.py`, `test_brand_theme.py`, `test_craft.py`, `test_email_render.py`, `test_grounding.py`, `test_rehearse.py`, `web.py`
...
- **`apply_decision`**(ap_id, decision) → `str`  ·  from `test_campaign_variety.py`, `test_draft_sync.py`, `test_gbp_post.py`, `test_learning.py`, `test_rehearse.py`, `test_reports_skill.py`, `test_systems.py`, `web.py`
...
- **`request_approval`**(kind, summary, payload, notify?, run_id?, system_id?) → `str`  ·  from `command_agent.py`, `correlate.py`, `learning.py`, `metrics.py`, `ops_jobs.py`, `seed_demo.py`, `seo_tools.py`, `shopify_webhooks.py`, `skill.py`, `skills.py`, `test_console_frame.py`, `test_correlate.py`, `test_diagnostics.py`, `test_digest.py`, `test_draft_sync.py`, `test_learning.py`, `test_replies.py`, `test_review_tab.py`, `test_ship_section.py`, `test_systems.py`, `test_systems_board.py`, `web.py`, `worker.py`
...
- **`trend`**(tenant?, days?) → `list`  ·  from `admin_ui.py`, `test_claim_trace.py`, `test_learning.py`
...
- **`trend`**(tenant, system_key, windows?) → `dict`  ·  from `admin_ui.py`, `test_claim_trace.py`, `test_learning.py`
...
- **`render`**(theme, blocks, preheader?, webview?) → `str`  ·  from `admin_ui.py`, `skill_pack.py`, `test_brand_theme.py`, `test_craft.py`, `test_email_render.py`, `test_grounding.py`, `test_rehearse.py`, `web.py`
...
- **`location`**(tenant, name) → `dict`  ·  from `test_gbp.py`
...
- **`render`**(bundle) → `str`  ·  from `admin_ui.py`, `skill_pack.py`, `test_brand_theme.py`, `test_craft.py`, `test_email_render.py`, `test_grounding.py`, `test_rehearse.py`, `web.py`
...
- **`ensure_brand`**(tenant, display_name?) → `db.KbBrand`  ·  from `brand_theme.py`, `seed_demo.py`, `test_ad_board.py`, `test_allclear.py`, `test_article_images.py`, `test_article_picture.py`, `test_article_repair.py`, `test_article_review.py`, `test_assurance_tab.py`, `test_audience_entities.py`, `test_auto_ships.py`, `test_ban_list.py`, `test_blog_path.py`, `test_blog_readiness.py`, `test_blog_skill.py`, `test_brand_theme.py`, `test_bundle_contract.py`, `test_campaign_email.py`, `test_campaign_measured.py`, `test_campaign_variety.py`, `test_campaign_visual.py`, `test_catalog_vocabulary.py`, `test_claim_expiry.py`, `test_claim_fix.py`, `test_claim_rotation.py`, `test_coherence.py`, `test_compliance_reports.py`, `test_console_frame.py`, `test_context.py`, `test_correlate.py`, `test_craft.py`, `test_diagnostics.py`, `test_dossier.py`, `test_entity_group.py`, `test_entity_scope.py`, `test_funnel.py`, `test_gbp_post.py`, `test_grounding.py`, `test_harvest.py`, `test_kb_ui.py`, `test_learning.py`, `test_new_organization.py`, `test_offers.py`, `test_perishable.py`, `test_plan_lifecycle.py`, `test_pointer_fixes.py`, `test_propose.py`, `test_provenance.py`, `test_publish_gap.py`, `test_queue_approval.py`, `test_refresh_lands.py`, `test_refresh_lane.py`, `test_rehearsal_fixes.py`, `test_render_smoke.py`, `test_replies.py`, `test_reports_skill.py`, `test_reset.py`, `test_resolve.py`, `test_responder.py`, `test_review_tab.py`, `test_run_skill.py`, `test_schedule_nav.py`, `test_schema_tab.py`, `test_seo_guard.py`, `test_shopify_compliance.py`, `test_skill.py`, `test_strategy_ledger.py`, `test_support_links.py`, `test_systems.py`, `test_tenant_isolation.py`, `test_voice.py`, `test_workroom_email.py`, `web.py`
- **`entities`**(tenant, type?, available_only?, include_proposed?) → `list[db.KbEntity]`  ·  from `admin_ui.py`, `brief.py`, `claim_trace.py`, `creative.py`, `dossier.py`, `harvest.py`, `links.py`, `offers.py`, `planner.py`, `resolve.py`, `skill_pack.py`, `systems.py`, `tenants.py`, `test_campaign_variety.py`, `test_catalog_sync.py`, `test_entity_selectors.py`, `test_kb.py`, `test_kb_removal.py`, `test_kb_ui.py`, `test_objection_scope.py`, `test_provenance.py`, `test_shopify_compliance.py`, `validator.py`, `web.py`
...
- **`targets`**(tenant, tier?, status?, cluster_key?) → `list[db.KeywordTarget]`  ·  from `funnel.py`, `planner.py`, `skill_pack.py`, `test_blog_skill.py`, `test_keyword_progress.py`, `test_keywords.py`, `test_link_flag.py`, `test_pointer_fixes.py`, `test_question_backlog.py`, `test_support_links.py`, `web.py`
...
- **`render`**() → `str`  ·  from `admin_ui.py`, `skill_pack.py`, `test_brand_theme.py`, `test_craft.py`, `test_email_render.py`, `test_grounding.py`, `test_rehearse.py`, `web.py`
...
- **`blog_rollout`**(sysrow) → `dict`  ·  from `test_blog_skill.py`, `test_keywords.py`, `test_link_flag.py`, `test_refresh_lane.py`, `web.py`
...
- **`render`**(tenant, tab?, days?, who?, notice?) → `str`  ·  from `admin_ui.py`, `skill_pack.py`, `test_brand_theme.py`, `test_craft.py`, `test_email_render.py`, `test_grounding.py`, `test_rehearse.py`, `web.py`
...
- **`create`**(tenant, key, name?) → `db.System`  ·  from `ab_context.py`, `correlate.py`, `data_tools.py`, `drive_io.py`, `extract.py`, `gmail_client.py`, `kernel.py`, `llm.py`, `responder.py`, `seed_demo.py`, `skill_pack.py`, `skills.py`, `test_ad_board.py`, `test_allclear.py`, `test_approval_gate.py`, `test_article_repair.py`, `test_article_review.py`, `test_audience_entities.py`, `test_auto_ships.py`, `test_blog_readiness.py`, `test_blog_skill.py`, `test_bridge.py`, `test_bundle_contract.py`, `test_cadence_knobs.py`, `test_campaign_email.py`, `test_campaign_measured.py`, `test_campaign_variety.py`, `test_campaign_visual.py`, `test_coherence.py`, `test_compliance.py`, `test_compliance_reports.py`, `test_console_controls.py`, `test_console_frame.py`, `test_correlate.py`, `test_diagnostics.py`, `test_entity_scope.py`, `test_entity_selectors.py`, `test_funnel.py`, `test_gbp.py`, `test_gbp_post.py`, `test_grounding.py`, `test_kb_ui.py`, `test_keywords.py`, `test_learning.py`, `test_link_flag.py`, `test_metrics.py`, `test_moment_pressure.py`, `test_offers.py`, `test_ops_added.py`, `test_plan_lifecycle.py`, `test_planner.py`, `test_plans.py`, `test_pointer_fixes.py`, `test_question_backlog.py`, `test_queue_approval.py`, `test_refresh_lands.py`, `test_refresh_lane.py`, `test_rehearsal_fixes.py`, `test_rehearse.py`, `test_reorder_skill.py`, `test_replies.py`, `test_report_planner.py`, `test_reports_skill.py`, `test_review_ui.py`, `test_run_skill.py`, `test_schedule_nav.py`, `test_schema_tab.py`, `test_segments.py`, `test_skill.py`, `test_strategy.py`, `test_strategy_ledger.py`, `test_support_links.py`, `test_systems.py`, `test_systems_check.py`, `test_workflow_ui.py`, `test_workroom_email.py`, `triage.py`, `voice.py`, `web.py`, `worker.py`
...
- **`is_on`**(system) → `bool`  ·  from `admin_ui.py`, `keywords.py`, `ops_jobs.py`, `performance.py`, `planner.py`, `skill.py`, `test_job_lease.py`, `test_replies.py`, `worker.py`
...
- **`open_plan`**(tenant, key, ref?, plan?, planned_for?, trigger?) → `dict`  ·  from `planner.py`, `seed_demo.py`, `test_article_review.py`, `test_entity_selectors.py`, `test_gbp_post.py`, `test_plan_lifecycle.py`, `test_plan_tab.py`, `test_plans.py`, `test_schedule_nav.py`, `test_workflow_ui.py`, `web.py`
...
- **`plans`**(tenant, key?, due_by?) → `list[db.SystemRun]`  ·  from `admin_ui.py`, `planner.py`, `test_gbp_post.py`, `test_plan_lifecycle.py`, `test_planner.py`, `test_plans.py`, `test_question_backlog.py`, `test_schedule_nav.py`, `test_support_links.py`, `test_workflow_ui.py`, `worker.py`
...
- **`save_plan`**(run_id, edits?, planned_for?) → `dict`  ·  from `test_entity_selectors.py`, `test_gbp_post.py`, `test_planner.py`, `test_plans.py`, `web.py`
...
- **`set_cadence`**(system_id, **values) → `dict`  ·  from `test_cadence_knobs.py`, `test_moment_pressure.py`, `test_planner.py`, `web.py`
