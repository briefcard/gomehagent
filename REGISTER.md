...
- Tables with writers: **59** (11 with more than one)
...
- **`render_plan`**(key, tenant?, msg?, err?, pick?, days?, probe?, sub?, ssort?, sdesc?) → `str`  ·  from `test_blog_readiness.py`, `test_console_controls.py`, `test_plan_tab.py`, `test_ship_section.py`, `web.py`
...
- **`harvest`**(tenant, design_id?, entity_key?, wait?, asset_id?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_units.py`, `web.py`
...
- **`harvest`**(tenant, limit?, apply?, use_model?, recrawl?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_units.py`, `web.py`
...
- **`harvest`**(tenant, seeds?, sources?, days?, limit?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_units.py`, `web.py`
- **`harvest_all`**(limit?) → `dict`  ·  from `test_harvest.py`, `web.py`
- **`harvest_due`**(tenant) → `bool`  ·  from `test_keyword_progress.py`
- **`harvest_estimate`**(tenant, sources?, seeds?, limit?) → `int`  ·  from `test_semrush_units.py`
...
- **`record_reading`**(tenant, phrase, source?, position?, impressions?, clicks?, ctr?, url?, database?) → `str`  ·  from `test_article_review.py`, `test_blog_readiness.py`, `test_blog_skill.py`, `test_keyword_progress.py`, `test_keywords.py`, `test_plan_mix.py`, `test_semrush_units.py`
...
- **`targets`**(tenant, tier?, status?, cluster_key?) → `list[db.KeywordTarget]`  ·  from `funnel.py`, `planner.py`, `skill_pack.py`, `test_blog_skill.py`, `test_keyword_progress.py`, `test_keywords.py`, `test_link_flag.py`, `test_plan_mix.py`, `test_pointer_fixes.py`, `test_question_backlog.py`, `test_support_links.py`, `web.py`
...
- **`harvest`**(tenant, days?, apply?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_units.py`, `web.py`
...
- **`reset`**(tenant, groups?, apply?) → `dict`  ·  from `seo_tools.py`, `test_reset.py`, `web.py`
...
- **`balance_cached`**(max_age_hours?) → `dict`  ·  from `diagnostics.py`, `test_semrush_units.py`, `web.py`
- **`balance_reading`**() → `dict`  ·  **from nothing**
- **`cap_for`**(tenant) → `int`  ·  from `test_semrush_units.py`
- **`capture_snapshot`**(domain?, database?, _tenant?) → `str`  ·  from `test_semrush_units.py`
...
- **`estimate`**(report, **params) → `int`  ·  from `keywords.py`
- **`halted`**() → `str`  ·  from `diagnostics.py`, `keywords.py`, `test_semrush_units.py`, `web.py`
...
- **`record_reading`**(units, source, halted_until?, note?) → `None`  ·  from `test_article_review.py`, `test_blog_readiness.py`, `test_blog_skill.py`, `test_keyword_progress.py`, `test_keywords.py`, `test_plan_mix.py`, `test_semrush_units.py`
...
- **`semrush_keyword_metrics`**(phrases, database?, _tenant?) → `str`  ·  from `test_semrush_units.py`
...
- **`read`**(tenant, days?) → `dict`  ·  from `admin_ui.py`, `brief_demo.py`, `layers.py`, `planner.py`, `test_a_canva_import_that_fails_falls_back_to_the_picture.py`, `test_a_claim_knows_what_it_is_about.py`, `test_a_second_image_provider_is_a_call_away.py`, `test_ad_arrives_whole.py`, `test_console_frame.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_effectiveness.py`, `test_job_lease.py`, `test_lead_reply.py`, `test_learning.py`, `test_rehearsal_fixes.py`, `test_rehearse.py`, `test_render_smoke.py`, `test_results.py`, `test_semrush_units.py`, `test_seo_guard.py`, `test_strategy.py`, `test_the_ban_list_reaches_the_fields.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `test_the_image_model_is_chosen_where_the_set_starts.py`, `test_the_route_sends_what_the_callee_takes.py`, `test_written_is_not_published.py`, `web.py`
