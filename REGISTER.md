...
- **`apply_decision`**(ap_id, decision) → `str`  ·  from `test_campaign_variety.py`, `test_draft_sync.py`, `test_gbp_listing.py`, `test_gbp_post.py`, `test_learning.py`, `test_rehearse.py`, `test_reports_skill.py`, `test_systems.py`, `web.py`
...
- **`publish_gap`**(tenant) → `dict`  ·  from `admin_ui.py`, `skill_pack.py`, `test_publish_gap.py`
