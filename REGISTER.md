...
- **`render_content`**(key, tenant?, started?, err?, msg?, cpage?, sub?, q?, flt?, corigin?) → `str`  ·  from `test_brand_sources.py`, `test_creative_batch.py`, `test_draft_sync.py`, `test_kb_ui.py`, `test_provenance.py`, `test_review_tab.py`, `test_ship_section.py`, `test_the_board_reaches_the_generator.py`, `web.py`
