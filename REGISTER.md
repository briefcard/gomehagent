...
- **`plans`**(tenant, key?, due_by?) → `list[db.SystemRun]`  ·  from `admin_ui.py`, `planner.py`, `skill_pack.py`, `test_gbp_post.py`, `test_plan_lifecycle.py`, `test_planner.py`, `test_plans.py`, `test_question_backlog.py`, `test_schedule_nav.py`, `test_support_links.py`, `test_workflow_ui.py`, `worker.py`
