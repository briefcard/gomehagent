...
- **`harvest`**(tenant, design_id?, entity_key?, wait?, asset_id?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_asked_once.py`, `test_semrush_units.py`, `web.py`
...
- **`sync_shopify`**(tenant, limit?, dry_run?) → `dict`  ·  from `skill_pack.py`, `sources.py`, `test_catalog_sync.py`, `test_kb_removal.py`, `test_the_brands_own_pictures_are_the_references.py`, `web.py`
...
- **`record_scan`**(tenant, result) → `str`  ·  from `test_compliance.py`, `test_compliance_reports.py`, `test_correlate.py`, `test_kb_ui.py`, `test_the_brands_own_pictures_are_the_references.py`, `web.py`, `worker.py`
...
- **`signature`**(sequence) → `str`  ·  from `jobs.py`, `pictures.py`, `skill.py`, `test_a_claim_knows_what_it_is_about.py`, `test_ad_arrives_whole.py`, `test_review_is_honest.py`, `test_tenant_isolation.py`, `test_the_route_sends_what_the_callee_takes.py`, `web.py`
...
- **`harvest`**(tenant, limit?, apply?, use_model?, recrawl?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_asked_once.py`, `test_semrush_units.py`, `web.py`
...
- **`drain`**(tenant, holder, limit?) → `dict`  ·  from `test_a_run_that_made_nothing_says_why.py`, `test_article_review.py`, `test_gbp_listing.py`, `test_job_queue.py`, `test_workflow_ui.py`, `worker.py`
- **`enqueue`**(tenant, kind_, payload?, system_key?, label?, dedupe?) → `dict`  ·  from `test_a_pinterest_board_link_fills_a_board.py`, `test_a_run_that_made_nothing_says_why.py`, `test_creative_batch.py`, `test_job_queue.py`, `test_the_model_takes_what_the_docs_say.py`, `test_the_queue_is_visible.py`, `web.py`
- **`finish`**(job_id, state, detail?, run_id?) → `None`  ·  from `test_a_pinterest_board_link_fills_a_board.py`, `test_creative_batch.py`, `test_job_queue.py`, `test_the_model_takes_what_the_docs_say.py`, `test_the_queue_is_visible.py`
...
- **`summarise`**(result) → `str`  ·  **from nothing**
...
- **`harvest`**(tenant, seeds?, sources?, days?, limit?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_asked_once.py`, `test_semrush_units.py`, `web.py`
...
- **`harvest`**(tenant, days?, apply?) → `dict`  ·  from `sources.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_brand_sources.py`, `test_harvest.py`, `test_hosting.py`, `test_keywords.py`, `test_offers.py`, `test_pointer_fixes.py`, `test_rivals.py`, `test_semrush_asked_once.py`, `test_semrush_units.py`, `web.py`
...
- **`signature`**(blob) → `dict`  ·  from `jobs.py`, `pictures.py`, `skill.py`, `test_a_claim_knows_what_it_is_about.py`, `test_ad_arrives_whole.py`, `test_review_is_honest.py`, `test_tenant_isolation.py`, `test_the_route_sends_what_the_callee_takes.py`, `web.py`
...
- **`bg_status`**(label, tenant) → `dict`  ·  from `admin_ui.py`, `test_job_queue.py`
