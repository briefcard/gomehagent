...
- Tables with writers: **61** (11 with more than one)
...
- **`match`**(query) → `list[dict]`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `gbp_post.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `test_review_is_honest.py`, `test_the_review_answers_one_question.py`, `web.py`
...
- **`ask`**(question, field, options?) → `—`  ·  route `GET /admin/ask`  ·  from `brief.py`, `creative.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
...
- **`can_illustrate`**(tenant) → `dict`  ·  from `keywords.py`, `test_can_this_account_illustrate.py`
...
- **`pick`**(tenant, commitment?, fmt?, entity_key?, audience_key?, claim?, prominent?, positioning?, channel?, situation?, boards?) → `dict`  ·  from `skill_pack.py`, `test_creative_seam.py`, `test_the_board_reaches_the_generator.py`
...
- **`ask`**(purpose, prompt, tenant?, system?, model?, max_tokens?, **extra) → `Reply`  ·  route `GET /admin/ask`  ·  from `brief.py`, `channel.py`, `creative.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
...
- **`match`**(tenant, limit?) → `dict`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `gbp_post.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `test_review_is_honest.py`, `test_the_review_answers_one_question.py`, `web.py`
...
- **`ask`**(question, field, options?) → `int`  ·  route `GET /admin/ask`  ·  from `brief.py`, `channel.py`, `creative.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
...
- **`ask`**(key?, q?, role?, thread?) → `str`  ·  route `GET /admin/ask`  ·  from `brief.py`, `channel.py`, `creative.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
