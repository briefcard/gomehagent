...
- **`panel_prompt`**(bundle, concepts) → `list[str]`  ·  from `skill_pack.py`, `test_ad_panel.py`, `test_the_ad_is_about_the_thing_you_chose.py`
...
- **`boards_select`**(tenant, name?) → `str`  ·  from `test_the_board_reaches_the_generator.py`
...
- **`render_brand`**(key, tenant?, msg?, err?, derive_voice?, pick?) → `str`  ·  from `test_ban_list.py`, `test_brand_sources.py`, `test_brand_theme.py`, `test_kb_ui.py`, `web.py`
- **`render_connect`**(link, tenant, rows, msg?, err?) → `str`  ·  from `web.py`
- **`render_content`**(key, tenant?, started?, err?, msg?, cpage?, sub?, q?, flt?, corigin?) → `str`  ·  from `test_a_frame_arrives_in_canva_as_layers.py`, `test_a_kept_frame_has_its_placements_and_no_painted_type.py`, `test_brand_sources.py`, `test_canva_falls_back_to_the_agency.py`, `test_creative_batch.py`, `test_draft_sync.py`, `test_kb_ui.py`, `test_provenance.py`, `test_review_tab.py`, `test_ship_section.py`, `test_the_board_reaches_the_generator.py`, `test_the_product_is_judged_against_its_photographs.py`, `web.py`
...
- **`add_board`**(tenant, name, note?) → `str`  ·  from `test_a_kept_frame_has_its_placements_and_no_painted_type.py`, `test_ad_board.py`, `test_the_board_reaches_the_generator.py`, `test_the_product_is_judged_against_its_photographs.py`, `web.py`
...
- **`boards`**(tenant) → `dict`  ·  from `admin_ui.py`, `test_the_board_reaches_the_generator.py`, `web.py`
...
- **`ad_prompt`**(bundle, claim, angle, objections) → `list[str]`  ·  from `test_ad_craft.py`, `test_ad_panel.py`, `test_the_ad_is_about_the_thing_you_chose.py`
...
- **`read`**(tenant, days?) → `dict`  ·  from `admin_ui.py`, `brief_demo.py`, `layers.py`, `planner.py`, `test_a_claim_knows_what_it_is_about.py`, `test_ad_arrives_whole.py`, `test_console_frame.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_effectiveness.py`, `test_job_lease.py`, `test_lead_reply.py`, `test_learning.py`, `test_rehearsal_fixes.py`, `test_rehearse.py`, `test_render_smoke.py`, `test_results.py`, `test_seo_guard.py`, `test_strategy.py`, `test_the_ban_list_reaches_the_fields.py`, `test_the_route_sends_what_the_callee_takes.py`, `test_written_is_not_published.py`, `web.py`
