...
- **`attention`**(tenant, top?) → `list[dict]`  ·  from `admin_ui.py`, `planner.py`, `test_board_cost.py`, `test_cadence_knobs.py`, `test_diagnostics_surface.py`, `test_keyword_attention.py`, `test_refresh_lands.py`, `test_refresh_lane.py`, `test_support_links.py`, `test_systems_check.py`
...
- **`next_to_write`**(tenant, top?) → `list`  ·  from `test_mute_replacement.py`, `web.py`
...
- **`attention`**(tenant?, days?, system_key?, examples?) → `list[dict]`  ·  from `admin_ui.py`, `planner.py`, `test_board_cost.py`, `test_cadence_knobs.py`, `test_diagnostics_surface.py`, `test_keyword_attention.py`, `test_refresh_lands.py`, `test_refresh_lane.py`, `test_support_links.py`, `test_systems_check.py`
