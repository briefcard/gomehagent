...
- **`effectiveness`**() → `list[dict]`  ·  from `gen_systems_reference.py`, `test_effectiveness.py`, `test_lead_reply.py`, `test_reports_skill.py`
