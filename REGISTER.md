...
- **`status`**(tenant) → `dict`  ·  from `admin_ui.py`, `portal_ui.py`, `test_brand_theme.py`, `test_canva_falls_back_to_the_agency.py`, `test_connect_ui.py`, `test_credentials.py`, `test_oauth.py`, `test_review_ui.py`, `test_shopify_oauth.py`, `web.py`
...
- **`close`**(tenant, conversation_id, outcome?) → `str`  ·  from `articles.py`, `commerce_events.py`, `shots.py`, `test_migration.py`
...
- **`status`**(tenant) → `list[dict]`  ·  from `admin_ui.py`, `portal_ui.py`, `test_brand_theme.py`, `test_canva_falls_back_to_the_agency.py`, `test_connect_ui.py`, `test_credentials.py`, `test_oauth.py`, `test_review_ui.py`, `test_shopify_oauth.py`, `web.py`
...
- **`signature`**(sequence) → `str`  ·  from `pictures.py`, `skill.py`, `test_a_claim_knows_what_it_is_about.py`, `test_ad_arrives_whole.py`, `test_review_is_honest.py`, `test_tenant_isolation.py`, `test_the_route_sends_what_the_callee_takes.py`, `web.py`
...
- **`latest`**(tenant) → `dict`  ·  from `admin_ui.py`, `recreate_once.py`, `test_the_model_makes_the_email.py`, `web.py`
...
- **`status`**() → `dict`  ·  from `admin_ui.py`, `portal_ui.py`, `test_brand_theme.py`, `test_canva_falls_back_to_the_agency.py`, `test_connect_ui.py`, `test_credentials.py`, `test_oauth.py`, `test_review_ui.py`, `test_shopify_oauth.py`, `web.py`
...
- **`close`**(moment_id, status, why?, consumed_by?) → `bool`  ·  from `articles.py`, `commerce_events.py`, `shots.py`, `test_migration.py`
...
- **`judge`**(reference_png, ours_png, brief_, tenant?, material?, notes?) → `dict`  ·  from `test_the_model_writes_the_article.py`
...
- **`read`**(tenant, days?) → `dict`  ·  from `admin_ui.py`, `articles.py`, `brief_demo.py`, `layers.py`, `planner.py`, `recreate.py`, `test_a_canva_import_that_fails_falls_back_to_the_picture.py`, `test_a_claim_knows_what_it_is_about.py`, `test_a_second_image_provider_is_a_call_away.py`, `test_ad_arrives_whole.py`, `test_an_action_never_renders_at_its_own_address.py`, `test_can_the_engines_read_us.py`, `test_console_frame.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_effectiveness.py`, `test_job_lease.py`, `test_lead_reply.py`, `test_learning.py`, `test_rehearsal_fixes.py`, `test_rehearse.py`, `test_render_smoke.py`, `test_results.py`, `test_semrush_asked_once.py`, `test_semrush_units.py`, `test_seo_guard.py`, `test_strategy.py`, `test_the_ban_list_reaches_the_fields.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `test_the_image_model_is_chosen_where_the_set_starts.py`, `test_the_route_sends_what_the_callee_takes.py`, `test_written_is_not_published.py`, `web.py`
