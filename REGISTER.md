...
- **`pick`**(tenant, commitment?, fmt?, entity_key?, audience_key?, claim?, prominent?, positioning?, channel?, situation?, boards?) → `dict`  ·  from `skill_pack.py`, `test_creative_seam.py`, `test_the_board_reaches_the_generator.py`, `test_the_model_makes_the_email.py`
...
- **`pick`**(tenant, intent?, fmt?, recent_shapes?, designated?, recent_designs?) → `dict`  ·  from `skill_pack.py`, `test_creative_seam.py`, `test_the_board_reaches_the_generator.py`, `test_the_model_makes_the_email.py`
...
- **`latest`**(tenant) → `dict`  ·  from `admin_ui.py`, `recreate_once.py`, `test_creative_batch.py`, `test_gbp_listing.py`, `test_job_queue.py`, `test_the_model_makes_the_email.py`, `web.py`
...
- **`drain`**(tenant, holder, limit?) → `dict`  ·  from `test_a_run_that_made_nothing_says_why.py`, `test_gbp_listing.py`, `test_job_queue.py`, `worker.py`
...
- **`latest`**(tenant, system_key?, kind_?) → `dict`  ·  from `admin_ui.py`, `recreate_once.py`, `test_creative_batch.py`, `test_gbp_listing.py`, `test_job_queue.py`, `test_the_model_makes_the_email.py`, `web.py`
...
- **`latest`**(structure_id, tenant) → `dict | None`  ·  from `admin_ui.py`, `recreate_once.py`, `test_creative_batch.py`, `test_gbp_listing.py`, `test_job_queue.py`, `test_the_model_makes_the_email.py`, `web.py`
