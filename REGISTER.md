...
- **`all_tenants`**(include_paused?) → `list[db.Tenant]`  ·  from `admin_ui.py`, `correlate.py`, `digest.py`, `harvest.py`, `inbox_events.py`, `kb.py`, `keywords.py`, `performance.py`, `seed_demo.py`, `sites.py`, `systems.py`, `test_article_repair.py`, `test_assurance_tab.py`, `test_console_frame.py`, `test_render_smoke.py`, `test_site_resolution.py`, `verify_canva.py`, `web.py`, `worker.py`
