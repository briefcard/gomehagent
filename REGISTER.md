...
- **`granted_scopes`**(tenant) → `dict[str, set[str] | None]`  ·  from `shopify_seo.py`, `sites.py`
...
- **`instrument`**(provider, fn) → `—`  ·  from `canva.py`, `constant_contact.py`, `klaviyo.py`, `omnisend.py`
