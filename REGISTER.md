...
- **`attention`**(tenant, top?) → `list[dict]`  ·  from `admin_ui.py`, `test_diagnostics_surface.py`, `test_keyword_attention.py`, `test_systems_check.py`
...
- **`attention`**(tenant?, days?, system_key?, examples?) → `list[dict]`  ·  from `admin_ui.py`, `test_diagnostics_surface.py`, `test_keyword_attention.py`, `test_systems_check.py`
