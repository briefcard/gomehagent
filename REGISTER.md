...
- **`put`**(tenant, blob, mime?, origin?) → `dict`  ·  from `canva.py`, `creative.py`, `recreate.py`, `test_a_canva_import_that_fails_falls_back_to_the_picture.py`, `test_a_frame_arrives_in_canva_as_layers.py`, `test_creative_seam.py`, `test_hosting.py`, `test_the_designs_shelf.py`, `web.py`
...
- **`norm`**(hexv) → `str`  ·  from `embed.py`, `recreate.py`
- **`on`**(hexv, dark?, light?) → `str`  ·  **from nothing**
- **`parse`**(hexv) → `tuple[int, int, int] | None`  ·  from `answer_engines.py`, `bundle.py`, `recreate.py`, `register.py`, `skill_pack.py`, `test_a_claim_knows_what_it_is_about.py`, `test_ad_arrives_whole.py`, `test_ad_craft.py`, `test_artifact_identity.py`, `test_assertions_can_fail.py`, `test_ban_list.py`, `test_can_this_account_illustrate.py`, `test_catalog_vocabulary.py`, `test_context.py`, `test_control_piping.py`, `test_creative_seam.py`, `test_pointers.py`, `test_register.py`, `test_sabotage_anchors.py`, `test_semrush_asked_once.py`, `test_skill_conformance.py`, `test_spend_complete.py`, `test_the_page_says_what_it_answers.py`, `test_the_route_sends_what_the_callee_takes.py`, `test_written_is_not_published.py`
