...
- **`fill`**(tenant, design, blocks, note?) → `tuple[list, dict]`  ·  from `brand_theme.py`, `email_render.py`, `skill_pack.py`, `test_a_brand_fills_the_roles.py`, `test_content_fits_the_design.py`, `test_sources.py`, `web.py`
...
- **`normalize`**(raw) → `tuple[dict, list[str]]`  ·  from `email_render.py`, `email_structures.py`, `test_a_design_is_executed.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_content_fits_the_design.py`, `test_the_reader_has_eyes.py`
- **`preview_blocks`**(tenant) → `list[dict]`  ·  **from nothing**
- **`preview_html`**(tenant, design) → `tuple[str, str]`  ·  from `admin_ui.py`
...
- **`prompt_strip`**(k, n, top, bottom, total) → `str`  ·  from `test_a_structure_is_how_not_what.py`, `test_the_reader_has_eyes.py`
...
- **`file_structure`**(name?, sequence?, source?, review?, profile?, fits_intents?, fits_formats?, source_url?, source_asset_id?, notes?, by?, look?, design?, read_info?) → `dict`  ·  from `email_design.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_structure_is_how_not_what.py`
...
- **`signature`**(sequence) → `str`  ·  from `skill.py`, `test_a_claim_knows_what_it_is_about.py`, `test_ad_arrives_whole.py`, `test_review_is_honest.py`, `test_tenant_isolation.py`, `test_the_route_sends_what_the_callee_takes.py`, `web.py`
...
- **`contrast`**(a, b) → `float`  ·  from `test_a_brand_fills_the_roles.py`
...
- **`findings`**(palette) → `list[str]`  ·  from `brand_theme.py`, `test_a_brand_fills_the_roles.py`
- **`from_pictures`**(blobs) → `dict[str, tuple[str, str]]`  ·  from `brand_theme.py`, `test_a_brand_fills_the_roles.py`
- **`luminance`**(hexv) → `float`  ·  from `test_a_brand_fills_the_roles.py`
