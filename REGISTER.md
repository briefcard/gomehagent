...
- **`plans`**(tenant, key?, due_by?) → `list[db.SystemRun]`  ·  from `admin_ui.py`, `planner.py`, `test_plan_lifecycle.py`, `test_planner.py`, `test_plans.py`, `test_support_links.py`, `test_workflow_ui.py`, `worker.py`
