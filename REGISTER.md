...
- **`open_plan`**(tenant, key, ref?, plan?, planned_for?, trigger?) → `dict`  ·  from `planner.py`, `seed_demo.py`, `test_article_review.py`, `test_plan_lifecycle.py`, `test_plan_tab.py`, `test_plans.py`, `test_schedule_nav.py`, `test_workflow_ui.py`, `web.py`
