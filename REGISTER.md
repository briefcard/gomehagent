...
- Tables with writers: **57** (11 with more than one)
...
- **`read`**(tenant, days?) → `dict`  ·  from `admin_ui.py`, `brief_demo.py`, `planner.py`, `test_console_frame.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_render_smoke.py`, `test_results.py`, `test_seo_guard.py`, `test_strategy.py`, `web.py`
