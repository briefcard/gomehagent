...
- **`render_brand`**(key, tenant?, msg?, err?, derive_voice?, pick?) → `str`  ·  from `test_a_kept_frame_has_its_placements_and_no_painted_type.py`, `test_ban_list.py`, `test_brand_sources.py`, `test_brand_theme.py`, `test_kb_ui.py`, `test_the_board_reaches_the_generator.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `web.py`
...
- **`board_inputs`**(tenant, entity_key, product_id?, boards?) → `dict`  ·  **from nothing**
...
- **`add_board`**(tenant, name, note?) → `str`  ·  from `test_a_kept_frame_has_its_placements_and_no_painted_type.py`, `test_ad_board.py`, `test_the_board_reaches_the_generator.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `test_the_product_is_judged_against_its_photographs.py`, `web.py`
...
- **`boards`**(tenant) → `dict`  ·  from `admin_ui.py`, `test_the_board_reaches_the_generator.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `web.py`
...
- **`pinned`**(row, boards_?) → `list`  ·  from `admin_ui.py`, `creative.py`, `test_the_board_reaches_the_generator.py`
...
- **`set_board_role`**(asset_id, board_slug, role, on?) → `str`  ·  from `test_a_kept_frame_has_its_placements_and_no_painted_type.py`, `test_the_board_reaches_the_generator.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `test_the_product_is_judged_against_its_photographs.py`, `web.py`
