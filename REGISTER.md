...
- **`claim`**(tenant, holder) → `str`  ·  from `test_creative_batch.py`, `test_job_queue.py`, `test_propose.py`, `test_the_model_takes_what_the_docs_say.py`, `web.py`
...
- **`enqueue`**(tenant, kind_, payload?, system_key?, label?, dedupe?) → `dict`  ·  from `test_a_pinterest_board_link_fills_a_board.py`, `test_a_run_that_made_nothing_says_why.py`, `test_creative_batch.py`, `test_job_queue.py`, `test_the_model_takes_what_the_docs_say.py`, `web.py`
- **`finish`**(job_id, state, detail?, run_id?) → `None`  ·  from `test_a_pinterest_board_link_fills_a_board.py`, `test_creative_batch.py`, `test_job_queue.py`, `test_the_model_takes_what_the_docs_say.py`
- **`heartbeat`**(job_id, detail?) → `None`  ·  from `test_creative_batch.py`, `test_job_queue.py`, `test_the_model_takes_what_the_docs_say.py`
...
- **`board`**(tenant, days?, top?) → `dict`  ·  from `admin_ui.py`, `creative.py`, `test_article_review.py`, `test_keyword_attention.py`, `test_keywords.py`, `test_mute_replacement.py`, `test_plan_lifecycle.py`, `test_systems.py`, `test_the_board_reaches_the_generator.py`, `web.py`
...
- **`claim`**(tenant, text, evidence, source_ref?, situations?, entity_key?) → `dict`  ·  from `test_creative_batch.py`, `test_job_queue.py`, `test_propose.py`, `test_the_model_takes_what_the_docs_say.py`, `web.py`
...
- **`board`**() → `list[dict]`  ·  from `admin_ui.py`, `creative.py`, `test_article_review.py`, `test_keyword_attention.py`, `test_keywords.py`, `test_mute_replacement.py`, `test_plan_lifecycle.py`, `test_systems.py`, `test_the_board_reaches_the_generator.py`, `web.py`
