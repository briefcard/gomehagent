...
- **`assemble`**(tenant, text, sender?, model_fn?) → `Brief`  ·  from `brief_demo.py`, `portal_ui.py`, `skill_pack.py`, `test_client_report.py`, `test_metrics.py`, `test_reports_skill.py`, `test_selection.py`, `web.py`
...
- **`read`**(tenant, days?) → `dict`  ·  from `admin_ui.py`, `brief_demo.py`, `planner.py`, `test_console_frame.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_effectiveness.py`, `test_job_lease.py`, `test_lead_reply.py`, `test_learning.py`, `test_render_smoke.py`, `test_results.py`, `test_seo_guard.py`, `test_strategy.py`, `web.py`
