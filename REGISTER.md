...
- **`match`**(query) → `list[dict]`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `gbp_post.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `test_review_is_honest.py`, `web.py`
...
- **`brief_for`**(tenant, commitment?, fmt?, prominent?, entity_key?, claim?, situation?, audience_key?, positioning?, composited?) → `dict`  ·  from `test_ad_arrives_whole.py`, `test_an_ad_may_look_like_an_ad.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_winning_look.py`
...
- **`match`**(tenant, limit?) → `dict`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `gbp_post.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `test_review_is_honest.py`, `web.py`
