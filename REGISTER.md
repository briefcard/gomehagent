...
- **`apply_decision`**(ap_id, decision) → `str`  ·  from `test_campaign_variety.py`, `test_draft_sync.py`, `test_learning.py`, `test_rehearse.py`, `test_reports_skill.py`, `test_systems.py`, `web.py`
...
- **`match`**(query) → `list[dict]`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `web.py`
...
- **`named_refusal`**(status, msg) → `str`  ·  from `test_gbp.py`
...
- **`match`**(tenant, limit?) → `dict`  ·  from `ad_craft.py`, `admin_ui.py`, `claim_trace.py`, `command_agent.py`, `edits.py`, `learning.py`, `oauth.py`, `ops_commands.py`, `test_results.py`, `web.py`
...
- **`knobs_for`**(sysrow) → `list[dict]`  ·  from `admin_ui.py`, `test_cadence_knobs.py`, `test_report_planner.py`
...
- **`open_plan`**(tenant, key, ref?, plan?, planned_for?, trigger?) → `dict`  ·  from `planner.py`, `seed_demo.py`, `test_article_review.py`, `test_entity_selectors.py`, `test_plan_lifecycle.py`, `test_plan_tab.py`, `test_plans.py`, `test_schedule_nav.py`, `test_workflow_ui.py`, `web.py`
...
- **`plans`**(tenant, key?, due_by?) → `list[db.SystemRun]`  ·  from `admin_ui.py`, `planner.py`, `test_plan_lifecycle.py`, `test_planner.py`, `test_plans.py`, `test_question_backlog.py`, `test_schedule_nav.py`, `test_support_links.py`, `test_workflow_ui.py`, `worker.py`
...
- **`save_plan`**(run_id, edits?, planned_for?) → `dict`  ·  from `test_entity_selectors.py`, `test_planner.py`, `test_plans.py`, `web.py`
