...
- **`model_select`**(name?) → `str`  ·  from `test_the_image_model_is_chosen_where_the_set_starts.py`
...
- **`render_workroom`**(key, output_id, art, kw, ap, ok?, err?) → `str`  ·  from `test_article_picture.py`, `test_publish_gap.py`, `test_queue_approval.py`, `test_refresh_lands.py`, `test_workroom_email.py`, `web.py`
- **`set_theme`**(value) → `None`  ·  from `web.py`

### `approvals.py`

- **`apply_decision`**(ap_id, decision) → `str`  ·  from `test_blog_destination.py`, `test_campaign_variety.py`, `test_draft_sync.py`, `test_gbp_listing.py`, `test_gbp_post.py`, `test_learning.py`, `test_rehearse.py`, `test_reports_skill.py`, `test_systems.py`, `web.py`
...
- **`request_approval`**(kind, summary, payload, notify?, run_id?, system_id?) → `str`  ·  from `command_agent.py`, `correlate.py`, `learning.py`, `metrics.py`, `ops_jobs.py`, `seed_demo.py`, `seo_tools.py`, `shopify_webhooks.py`, `skill.py`, `skill_pack.py`, `skills.py`, `test_console_frame.py`, `test_correlate.py`, `test_diagnostics.py`, `test_digest.py`, `test_draft_sync.py`, `test_learning.py`, `test_replies.py`, `test_review_tab.py`, `test_ship_section.py`, `test_systems.py`, `test_systems_board.py`, `web.py`, `worker.py`
- **`send_report`**(ap) → `str`  ·  **from nothing**
- **`ship_unattended`**(tenant, output_id, why?) → `dict`  ·  from `skill_pack.py`, `test_auto_ships.py`
...
- **`generate`**(tenant, commitment?, fmt?, prominent?, entity_key?, claim?, situation?, audience_key?, positioning?, prompt?, review?, boards?) → `dict`  ·  from `test_creative_seam.py`, `test_the_board_reaches_the_generator.py`, `web.py`
- **`harvest_drive`**(tenant, folder?, limit?) → `dict`  ·  from `test_the_harvest_reads_the_folder.py`, `web.py`
- **`hero_for_campaign`**(tenant, segment_key?, entity_keys?, title?, draft_if_missing?, boards?) → `dict`  ·  from `skill_pack.py`, `test_campaign_visual.py`, `test_creative_seam.py`, `test_the_board_reaches_the_generator.py`
...
- **`chosen`**(value) → `tuple[list[str], str]`  ·  from `test_the_image_model_is_chosen_where_the_set_starts.py`, `web.py`
...
- **`upsert`**(tenant, phrase, volume?, difficulty?, cpc?, source?, database?, **plan) → `db.KeywordTarget`  ·  from `embed.py`, `planner.py`, `seed_demo.py`, `skill_pack.py`, `systems.py`, `test_article_picture.py`, `test_article_review.py`, `test_blog_readiness.py`, `test_blog_skill.py`, `test_cadence_knobs.py`, `test_console_controls.py`, `test_embed.py`, `test_funnel.py`, `test_keyword_attention.py`, `test_keyword_progress.py`, `test_keywords.py`, `test_link_flag.py`, `test_mute_replacement.py`, `test_plan_lifecycle.py`, `test_plan_mix.py`, `test_plan_tab.py`, `test_progress_windows.py`, `test_question_backlog.py`, `test_refresh_effect.py`, `test_refresh_lane.py`, `test_render_smoke.py`, `test_support_links.py`
...
- **`place_images`**(body, tenant, commitment?, entity_key?, used?) → `tuple`  ·  from `test_article_images.py`
