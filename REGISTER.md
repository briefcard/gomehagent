...
- **`ask`**(question, field, options?) → `—`  ·  route `GET /admin/ask`  ·  from `brief.py`, `creative.py`, `email_structures.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
...
- **`house`**(look?, width?) → `dict`  ·  from `email_structures.py`, `test_a_design_is_words_the_renderer_can_draw.py`
- **`normalize`**(raw) → `tuple[dict, list[str]]`  ·  from `email_structures.py`, `test_a_design_is_words_the_renderer_can_draw.py`
...
- **`add_swipe`**(raw_url, tenant?) → `dict`  ·  from `test_a_reference_is_recreated.py`, `test_a_structure_is_how_not_what.py`, `web.py`
...
- **`file_structure`**(name?, sequence?, source?, review?, profile?, fits_intents?, fits_formats?, source_url?, source_asset_id?, notes?, by?, look?, design?) → `dict`  ·  from `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_structure_is_how_not_what.py`
- **`find_by_sequence`**(sequence) → `db.EmailStructure | None`  ·  **from nothing**
- **`library`**(review?) → `list[dict]`  ·  from `admin_ui.py`, `test_a_design_is_words_the_renderer_can_draw.py`, `test_a_structure_is_how_not_what.py`
...
- **`read_swipe`**(asset_id) → `dict`  ·  from `test_a_reference_is_recreated.py`, `test_a_structure_is_how_not_what.py`, `web.py`
...
- **`ask`**(purpose, prompt, tenant?, system?, model?, max_tokens?, **extra) → `Reply`  ·  route `GET /admin/ask`  ·  from `brief.py`, `channel.py`, `creative.py`, `email_structures.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
...
- **`image_fits`**(model, width, height) → `bool`  ·  from `test_a_reference_is_recreated.py`
- **`image_seen_as`**(model, width, height) → `tuple[int, int]`  ·  from `test_a_reference_is_recreated.py`
- **`image_tier`**(model) → `tuple[str, str]`  ·  from `test_a_reference_is_recreated.py`
...
- **`resized_size`**(width, height, max_edge?, max_tokens?) → `tuple[int, int]`  ·  from `test_a_reference_is_recreated.py`
...
- **`read`**(tenant, days?) → `dict`  ·  from `admin_ui.py`, `brief_demo.py`, `layers.py`, `planner.py`, `test_a_canva_import_that_fails_falls_back_to_the_picture.py`, `test_a_claim_knows_what_it_is_about.py`, `test_a_second_image_provider_is_a_call_away.py`, `test_ad_arrives_whole.py`, `test_an_action_never_renders_at_its_own_address.py`, `test_can_the_engines_read_us.py`, `test_console_frame.py`, `test_creative_batch.py`, `test_creative_seam.py`, `test_effectiveness.py`, `test_job_lease.py`, `test_lead_reply.py`, `test_learning.py`, `test_rehearsal_fixes.py`, `test_rehearse.py`, `test_render_smoke.py`, `test_results.py`, `test_semrush_asked_once.py`, `test_semrush_units.py`, `test_seo_guard.py`, `test_strategy.py`, `test_the_ban_list_reaches_the_fields.py`, `test_the_brand_tab_owns_the_boards_and_the_channel_rules.py`, `test_the_image_model_is_chosen_where_the_set_starts.py`, `test_the_route_sends_what_the_callee_takes.py`, `test_written_is_not_published.py`, `web.py`
...
- **`ask`**(question, field, options?) → `int`  ·  route `GET /admin/ask`  ·  from `brief.py`, `channel.py`, `creative.py`, `email_structures.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
...
- **`ask`**(key?, q?, role?, thread?) → `str`  ·  route `GET /admin/ask`  ·  from `brief.py`, `channel.py`, `creative.py`, `email_structures.py`, `learning.py`, `ops_jobs.py`, `skill_pack.py`, `skills.py`, `test_llm.py`, `triage.py`, `voice_learn.py`
