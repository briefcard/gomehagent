...
## 6d. (retired) The token email chain

Deleted 2026-09-14 — the closed design vocabulary, its reader, its painter
and its previews. An email is made by the maker (§6e); a reference is read
into words, never tokens. The owner: *"You keep over-engineering everything."*
