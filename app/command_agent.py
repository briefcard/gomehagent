...
from . import approvals, config, data_tools, db, digest, gmail_client, ops_jobs
...
def handle(text: str) -> str:
    """Process one free-text command; returns the reply to send back."""
    ...
    return "I hit my step limit on that one — try breaking it into smaller asks."
