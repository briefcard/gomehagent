...
PROVIDERS: dict[str, dict] = {
    ...
    "wordpress": dict(
        ...
        starts=""),
    "google": dict(
        name="Google (Gmail, Drive, Calendar, Analytics)",
        kind="oauth",
        capability="inbox",
        field="",
        also={},
        howto="Connected by signing in with Google. Not self-serve yet — we will "
              "do this together on a short call.",
        starts=""),
    "meta_ads": dict(
        name="Meta Ads",
        kind="oauth",
        ...
        field="",
        also={},
        howto="Connected by signing in with Meta. Not self-serve yet.",
        starts=""),
}
...
def needed_for(tenant: str) -> list[str]:
    ...
    return [k for k, v in PROVIDERS.items() if v["capability"] in caps]
